import{i as N,h as g,j as H,k as V,l as A,m as _,n as T,p as D,q as R,_ as B,s as K,e as L,o as i,c as t,b as $,w as E,a as e,v,F as m,r as k,t as z,u as w,x as M,y as I}from"./app-B4p_qqhv.js";function s1(h,o={}){const s=o.head||N();if(s)return s.ssr?s.push(h,o):P(s,h,o)}function P(h,o,s={}){const r=g(!1),u=g({});H(()=>{u.value=r.value?{}:D(o)});const d=h.push(u.value,s);return V(u,l=>{d.patch(l)}),R()&&(A(()=>{d.dispose()}),_(()=>{r.value=!0}),T(()=>{r.value=!1})),d}const j=[{id:1,name:"Toyota",altName:"toyota",imgSrc:"/test/images/logos/toyota.png",link:"/servis-japanskih-vozila/toyota",alt:"Toyota car logo - Nacional Auto"},{id:2,name:"Honda",altName:"honda",imgSrc:"/test/images/logos/honda.png",link:"/servis-japanskih-vozila/honda",alt:"Honda car logo - Nacional Auto"},{id:3,name:"Mazda",altName:"mazda",imgSrc:"/test/images/logos/mazda.png",link:"/servis-japanskih-vozila/mazda",alt:"Mazda car logo - Nacional Auto"},{id:4,name:"Nissan",altName:"nissan",imgSrc:"/test/images/logos/nissan.png",link:"/servis-japanskih-vozila/nissan",alt:"Nissan car logo - Nacional Auto"},{id:5,name:"Mitsubishi",altName:"mitsubishi",imgSrc:"/test/images/logos/mitsubishi.png",link:"/servis-japanskih-vozila/mitsubishi",alt:"Mitsubishi car logo - Nacional Auto"},{id:6,name:"Suzuki",altName:"suzuki",imgSrc:"/test/images/logos/suzuki.png",link:"/servis-japanskih-vozila/suzuki",alt:"Suzuki car logo - Nacional Auto"},{id:7,name:"Subaru",altName:"subaru",imgSrc:"/test/images/logos/subaru.png",link:"/servis-japanskih-vozila/subaru",alt:"Subaru car logo - Nacional Auto"},{id:8,name:"Daihatsu",altName:"daihatsu",imgSrc:"/test/images/logos/daihatsu.png",link:"/servis-japanskih-vozila/daihatsu",alt:"Daihatsu car logo - Nacional Auto"},{id:9,name:"Isuzu",altName:"isuzu",imgSrc:"/test/images/logos/isuzu.png",link:"/servis-japanskih-vozila/isuzu",alt:"Isuzu car logo - Nacional Auto"}],y=[{id:1,name:"Hyundai",altName:"hyundai",imgSrc:"/test/images/logos/hyundai.png",link:"/servis-korejskih-vozila/hyundai",alt:"Hyundai car logo - Nacional Auto"},{id:2,name:"Kia",altName:"kia",imgSrc:"/test/images/logos/kia.png",link:"/servis-korejskih-vozila/kia",alt:"Kia car logo - Nacional Auto"},{id:3,name:"Chevrolet / Daewoo",altName:"chevrolet",imgSrc:"/test/images/logos/chevrolet.png",link:"/servis-korejskih-vozila/chevrolet",alt:"Chevrolet car logo - Nacional Auto"}],i1={daihatsu:["Daihatsu Sirion","Daihatsu Terios","Daihatsu YRV","Daihatsu Rocky","..."],honda:["Honda Jazz","Honda Civic","Honda Accord","Honda H-RV","Honda C-RV","..."],isuzu:["Isuzu D-Max","Isuzu Trooper","Isuzu N-Series","Isuzu F-Series","..."],mazda:["Mazda 2","Mazda 3","Mazda 5","Mazda 6","Mazda CX-3","Mazda CX-5","Mazda CX-30","Mazda CX-50","..."],mitsubishi:["Mitsubishi Lancer","Mitsubishi Outlander","Mitsubishi ASX","Mitsubishi Eclipse Cross","Mitsubishi Pajero","Mitsubishi Colt","..."],nissan:["Nissan Micra","Nissan Juke","Nissan Qashqai","Nissan X-Trail","Nissan Leaf","Nissan Navara","Nissan Pathfinder","..."],subaru:["Subaru Impreza","Subaru Outback","Subaru Forester","Subaru XV","Subaru Legacy","..."],suzuki:["Suzuki Swift","Suzuki Vitara","Suzuki SX4","Suzuki Jimny","Suzuki S-Cross","..."],toyota:["Toyota Aygo","Toyota Yaris","Toyota Corolla","Toyota RAV4","Toyota Avensis","Toyota Auris","Toyota C-HR","Toyota Hilux","Toyota Verso","Toyota Proace","Toyota Land Cruiser","..."],hyundai:["Hyundai i10","Hyundai i20","Hyundai i30","Hyundai Elantra","Hyundai Tucson","Hyundai Santa Fe","Hyundai Kona","..."],chevrolet:["Chevrolet Aveo","Chevrolet Spark","Chevrolet Lacetti","Chevrolet Kalos","Chevrolet Cruze","..."],kia:["Kia Ceed","Kia Sportage","Kia Seltos","Kia Sorento","Kia Soul","Kia Xceed","Kia Carens","..."]},t1=[{icon:`<svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
</svg>`,title:"Priprema za Tehnički Pregled",description:"Pripremamo vozilo za tehnički pregled kako bismo vam pomogli da ga bez problema prođete."}],O="/test/images/nacional-auto-logo.png",X={class:"section flex items-center justify-between z-20 relative"},J={class:"hidden lg:flex items-center justify-between space-x-4"},F={key:0,class:"absolute bg-white shadow-lg w-full z-30"},U=["onClick"],q={key:0,class:"absolute bg-white shadow-lg w-full z-30"},W=["onClick"],Y={class:"px-6 py-12 space-y-4"},Q={class:"pl-4"},G=["onClick"],Z={class:"pl-4"},a1=["onClick"],n1={__name:"Nav",setup(h){const o=K(),s=g(!1),r=g(!1),u=g(!1),d=()=>{s.value=!0},b=()=>{s.value=!1},l=c=>{const a={japan:"/test/servis-japanskih-vozila",korea:"/test/servis-korejskih-vozila","about-us":"/test/o-nama"};o.push(a[c]||"/test/o-nama")},p=c=>{o.push(c)},C=c=>o.currentRoute.value.path.startsWith(c)?"drop-shadow-lg bg-amber-400 text-black font-medium rounded-md px-4 py-2":"drop-shadow-lg hover:bg-amber-400 hover:text-black font-medium bg-black text-white rounded-md px-4 py-2",f=c=>o.currentRoute.value.path.startsWith(c)?"text-amber-400":"text-black hover:text-amber-400";return(c,a)=>{const S=L("router-link");return i(),t("div",X,[$(S,{to:"/test"},{default:E(()=>a[11]||(a[11]=[e("img",{class:"w-[180px] sm:w-60",src:O,alt:"Nacional auto logo",loading:"lazy"},null,-1)])),_:1}),e("button",{onClick:d,class:"block lg:hidden drop-shadow-lg hover:bg-amber-400 hover:text-black font-medium bg-black text-white rounded-md px-4 py-2"},a[12]||(a[12]=[e("span",null,"☰",-1)])),e("div",J,[e("button",{class:v(C("/test/o-nama")),onClick:a[0]||(a[0]=n=>l("about-us"))}," O nama ",2),e("div",{class:"relative",onMouseover:a[2]||(a[2]=n=>r.value=!0),onMouseleave:a[3]||(a[3]=n=>r.value=!1)},[e("button",{class:v(C("/test/servis-japanskih-vozila")),onClick:a[1]||(a[1]=n=>l("japan"))}," Servis za japanska vozila ",2),r.value?(i(),t("div",F,[e("ul",null,[(i(!0),t(m,null,k(w(j),n=>(i(),t("li",{key:n.id,class:"px-4 py-2 hover:bg-gray-100 cursor-pointer",onClick:x=>p(n.link)},z(n.name),9,U))),128))])])):M("",!0)],32),e("div",{class:"relative",onMouseover:a[5]||(a[5]=n=>u.value=!0),onMouseleave:a[6]||(a[6]=n=>u.value=!1)},[e("button",{class:v(C("/test/servis-korejskih-vozila")),onClick:a[4]||(a[4]=n=>l("korea"))}," Servis za korejska vozila ",2),u.value?(i(),t("div",q,[e("ul",null,[(i(!0),t(m,null,k(w(y),n=>(i(),t("li",{key:n.id,class:"px-4 py-2 hover:bg-gray-100 cursor-pointer",onClick:x=>p(n.link)},z(n.name),9,W))),128))])])):M("",!0)],32)]),s.value?(i(),t("div",{key:0,class:"fixed inset-0 bg-black bg-opacity-50 z-40 flex",onClick:b},[e("div",{onClick:a[10]||(a[10]=I(()=>{},["stop"])),class:v(["w-2/3 bg-white h-full shadow-lg transform transition-transform duration-300 ease-in-out",{"translate-x-0":s.value,"translate-x-full":!s.value}])},[e("button",{onClick:b,class:"absolute top-4 right-4 text-black"},a[13]||(a[13]=[e("span",null,"✕",-1)])),e("div",Y,[e("button",{class:v([f("/test/o-nama"),"w-full flex justify-between items-cente"]),onClick:a[7]||(a[7]=n=>l("aboutUs"))}," O nama ",2),e("div",null,[e("button",{onClick:a[8]||(a[8]=n=>l("japan")),class:v([f("/test/servis-japanskih-vozila"),"w-full flex justify-between items-cente"])}," Servis za japanska vozila ",2),e("ul",Q,[(i(!0),t(m,null,k(w(j),n=>(i(),t("li",{key:n.id,class:"py-2 hover:text-amber-400 cursor-pointer",onClick:x=>p(n.link)},z(n.name),9,G))),128))])]),e("div",null,[e("button",{onClick:a[9]||(a[9]=n=>l("korea")),class:v([f("/test/servis-korejskih-vozila"),"w-full flex justify-between items-cente"])}," Servis za korejska vozila ",2),e("ul",Z,[(i(!0),t(m,null,k(w(y),n=>(i(),t("li",{key:n.id,class:"py-2 hover:text-amber-400 cursor-pointer",onClick:x=>p(n.link)},z(n.name),9,a1))),128))])])])],2)])):M("",!0)])}}},o1=B(n1,[["__scopeId","data-v-4be704b8"]]);export{i1 as C,j as J,y as K,o1 as N,t1 as S,s1 as u};
